...
@InputType()
class InventoryItemCreateNestedManyWithoutSuppliersInput {
...
export { InventoryItemCreateNestedManyWithoutSuppliersInput as InventoryItemCreateNestedManyWithoutSuppliersInput };
