...
@InputType()
class InventoryItemUpdateManyWithoutWarehousesInput {
...
export { InventoryItemUpdateManyWithoutWarehousesInput as InventoryItemUpdateManyWithoutWarehousesInput };
