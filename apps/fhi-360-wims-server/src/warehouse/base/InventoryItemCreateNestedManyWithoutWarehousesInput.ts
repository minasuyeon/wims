...
@InputType()
class InventoryItemCreateNestedManyWithoutWarehousesInput {
...
export { InventoryItemCreateNestedManyWithoutWarehousesInput as InventoryItemCreateNestedManyWithoutWarehousesInput };
