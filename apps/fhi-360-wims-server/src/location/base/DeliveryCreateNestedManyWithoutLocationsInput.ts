...
@InputType()
class DeliveryCreateNestedManyWithoutLocationsInput {
...
export { DeliveryCreateNestedManyWithoutLocationsInput as DeliveryCreateNestedManyWithoutLocationsInput };
