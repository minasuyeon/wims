...
@InputType()
class PredictionCreateNestedManyWithoutProductsInput {
...
export { PredictionCreateNestedManyWithoutProductsInput as PredictionCreateNestedManyWithoutProductsInput };
