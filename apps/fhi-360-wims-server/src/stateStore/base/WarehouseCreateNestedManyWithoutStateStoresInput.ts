...
@InputType()
class WarehouseCreateNestedManyWithoutStateStoresInput {
...
export { WarehouseCreateNestedManyWithoutStateStoresInput as WarehouseCreateNestedManyWithoutStateStoresInput };
