...
@InputType()
class InventoryItemCreateNestedManyWithoutVendorsInput {
...
export { InventoryItemCreateNestedManyWithoutVendorsInput as InventoryItemCreateNestedManyWithoutVendorsInput };
