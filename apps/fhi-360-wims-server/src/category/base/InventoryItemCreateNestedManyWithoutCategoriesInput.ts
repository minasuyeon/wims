...
@InputType()
class InventoryItemCreateNestedManyWithoutCategoriesInput {
...
export { InventoryItemCreateNestedManyWithoutCategoriesInput as InventoryItemCreateNestedManyWithoutCategoriesInput };
